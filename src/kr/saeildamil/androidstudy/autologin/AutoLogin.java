...
public class AutoLogin extends Activity {
	...
	protected void onResume() {
		super.onResume();
		SharedPreferences myPrefs = (SharedPreferences) getSharedPreferences("my", MODE_PRIVATE);
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
		String idStr = myPrefs.getString("id", "");
		String pwStr = myPrefs.getString("pw", "");

		if (prefs.getBoolean("autologin", false)) {
			if (idStr.equals("root") & pwStr.equals("1234")) {
				loginBtn.setVisibility(View.GONE);
				result.setVisibility(View.VISIBLE);
				result.setText(idStr + "님 방가~~!");
			}
		}
	}
